...
#' @export
C3StackedChart <- function(idataset, icolors, types = NULL, groups = NULL, subchart = FALSE, axis_type = "timeseries", categories = NULL, width = NULL, height = NULL) {
...
#' @return C3 proxy object
#' @export
setColors <- function(chartProxy,icolors){
  Data <- list(id = chartProxy$id,icolors = icolors)
